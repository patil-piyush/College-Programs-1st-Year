...
void student::read()
{
    ...
    cur_id = ++id;
    cout << "ID assigned to this student is: " << cur_id << endl
         << "-----------------------------------------------------------------------" << endl;
}
...
void professor::read()
{
    ...
    cin >> publications;
    cur_id = ++id;
    cout << "ID assigned to this professor is: " << cur_id << endl
         << "-----------------------------------------------------------------------" << endl;
}
...
int main()
{
    student s[10];   // array of objects of class student
    professor p[10]; // array of objects of class professor
    int px = 0, sx = 0;
    while (1)
    {
        // main menu
